...
WebUI.setText(findTestObject('Object Repository/TC2.1 - Search Users/input_Username_oxd-input oxd-input--focus'), search_users)
...
WebUI.verifyElementPresent(findTestObject('TC2.2 - Search Users Negative (No Records Found)/div_InfoNo Records Found'), 
    0)
